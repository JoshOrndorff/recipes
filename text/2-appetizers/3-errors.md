...
[`decl_error!` macro](substrate.dev/rustdocs/v2.0.0-rc3/frame_support/macro.decl_error.html). Although it is
...
[`ensure!` macro](substrate.dev/rustdocs/v2.0.0-rc3/frame_support/macro.ensure.html) where the error to throw
