...
[`decl_error!` macro](https://substrate.dev/rustdocs/v2.0.0-rc6/frame_support/macro.decl_error.html). Although it is
...
[`ensure!` macro](https://substrate.dev/rustdocs/v2.0.0-rc6/frame_support/macro.ensure.html) where the error to throw
