...
[`StorageValue` trait](https://substrate.dev/rustdocs/v2.0.0-rc6/frame_support/storage/trait.StorageValue.html). In
...
[`ensure_signed` function](https://substrate.dev/rustdocs/v2.0.0-rc6/frame_system/fn.ensure_signed.html).
...
[`construct_runtime!` macro](https://substrate.dev/rustdocs/v2.0.0-rc6/frame_support/macro.construct_runtime.html) in
