...
](https://playground.substrate.dev/?deploy=recipes&files=%2Fhome%2Fsubstrate%2Fworkspace%2Fnodes%2Fbasic-pow%2Fsrc%2Fservice.rs)
[
...
-   Substrate's [import pipeline](https://substrate.dev/rustdocs/v2.0.0/sp_consensus/import_queue/index.html)
-   Structure of a typical [Substrate Service](https://substrate.dev/rustdocs/v2.0.0/sc_service/index.html)
-   Configuration of
    [`InherentDataProvider`](https://substrate.dev/rustdocs/v2.0.0/sp_authorship/struct.InherentDataProvider.html)s
...
[pre-runtime digests](https://substrate.dev/rustdocs/v2.0.0/sp_runtime/generic/enum.DigestItem.html#variant.PreRuntime).
...
The [Substrate Service](https://substrate.dev/rustdocs/v2.0.0/sc_service/index.html) is the main
...
[`ImportQueue`](https://substrate.dev/rustdocs/v2.0.0/sc_service/trait.ImportQueue.html).
Here we construct an instance of the
[`PowBlockImport` struct](https://substrate.dev/rustdocs/v2.0.0/sc_consensus_pow/struct.PowBlockImport.html),
...
[rustdocs tell us](https://substrate.dev/rustdocs/v2.0.0/sc_consensus_pow/struct.PowBlockImport.html#method.new)
...
[`ProvideInherentData` trait](https://substrate.dev/rustdocs/v2.0.0/sp_inherents/trait.ProvideInherentData.html)
...
[`TimestampInherentData`](https://substrate.dev/rustdocs/v2.0.0/sp_timestamp/trait.TimestampInherentData.html)
expected by the [timestamp pallet](https://substrate.dev/rustdocs/v2.0.0/pallet_timestamp/index.html). In order
...
[`start_mine` function](https://substrate.dev/rustdocs/v2.0.0/sc_consensus_pow/fn.start_mine.html) requires, and
