...
](https://playground.substrate.dev/?deploy=recipes&files=%2Fhome%2Fsubstrate%2Fworkspace%2Fpallets%2Frandomness%2Fsrc%2Flib.rs)
[
...
[`Randomness` trait](https://substrate.dev/rustdocs/v2.0.0/frame_support/traits/trait.Randomness.html), and
...
We've provided the `Output` type as [`H256`](https://substrate.dev/rustdocs/v2.0.0/sp_core/struct.H256.html).
...
Substrate's
[Randomness Collective Flip pallet](https://substrate.dev/rustdocs/v2.0.0/pallet_randomness_collective_flip/index.html)
...
Substrate's [Babe pallet](https://substrate.dev/rustdocs/v2.0.0/pallet_babe/index.html) which is primarily
