...
[`frame-support`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/index.html), and
[`frame-system`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_system/index.html). Complex pallets will have many
...
[`DispatchResult`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/dispatch/type.DispatchResult.html) which
...
shall be covered later in the section on [Weights](./weights.md). For now, and for may of
...
[`ensure_signed` function](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_system/fn.ensure_signed.html) to ensure
...
[`print` function](https://substrate.dev/rustdocs/v2.0.0-rc5/sp_runtime/fn.print.html) and
[`debug::info!` macro](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/debug/macro.info.html). The reason for
...
[`print` function](https://substrate.dev/rustdocs/v2.0.0-rc5/sp_runtime/fn.print.html). This special function allows
...
[`Printable` trait](https://substrate.dev/rustdocs/v2.0.0-rc5/sp_runtime/traits/trait.Printable.html). Luckily all
