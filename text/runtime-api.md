...
[`decl_runtime_apis!` macro](https://substrate.dev/rustdocs/v2.0.0/sp_api/macro.decl_runtime_apis.html). This
...
[`impl_runtime_apis!` macro](https://substrate.dev/rustdocs/v2.0.0/sp_api/macro.impl_runtime_apis.html). Every
runtime must use `iml_runtime_apis!` because the
[`Core` API](https://substrate.dev/rustdocs/v2.0.0/sp_api/trait.Core.html) is required. We will add an
...
[`impl_runtime_apis!`](https://substrate.dev/rustdocs/v2.0.0/sp_api/macro.impl_runtime_apis.html).
...
['client'](https://substrate.dev/rustdocs/v2.0.0/sc_service/client/struct.Client.html) we can make the call like
this.
