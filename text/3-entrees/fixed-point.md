...
[`PerThing` trait](https://substrate.dev/rustdocs/v2.0.0-rc6/sp_arithmetic/trait.PerThing.html), that cover different
amounts of precision. For this accumulator example, we'll use the
[`PerMill` struct](https://substrate.dev/rustdocs/v2.0.0-rc6/sp_arithmetic/struct.Permill.html) which represents
fractions as parts per million. There are also
[`Perbill`](https://substrate.dev/rustdocs/v2.0.0-rc6/sp_arithmetic/struct.Perbill.html),
[`PerCent`](https://substrate.dev/rustdocs/v2.0.0-rc6/sp_arithmetic/struct.Percent.html), and
[`PerU16`](https://substrate.dev/rustdocs/v2.0.0-rc6/sp_arithmetic/struct.PerU16.html), which all provide the same
...
[Balances pallet](https://substrate.dev/rustdocs/v2.0.0-rc6/pallet_balances/index.html) works, a tradition that's
...
[`Percent` type](https://substrate.dev/rustdocs/v2.0.0-rc6/sp_arithmetic/struct.Percent.html). It works nearly the
