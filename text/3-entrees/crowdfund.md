...
[child storage](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/storage/child/index.html).
...
[`Currency`](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/traits/trait.Currency.html), and three
...
contributed in a [child trie](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/storage/child/index.html). This
...
[`ChildInfo`](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/storage/child/enum.ChildInfo.html) for each of
...
[`Imbalance`](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/traits/trait.Imbalance.html)s as discussed in
