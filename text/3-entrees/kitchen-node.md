...
runtimes, and uses
[Instant Seal consensus](substrate.dev/rustdocs/v2.0.0-rc3/sc_consensus_manual_seal/index.html).
...
[`PreRuntime` `DigestItem`](substrate.dev/rustdocs/v2.0.0-rc3/sp_runtime/enum.DigestItem.html#variant.PreRuntime).
...
[`ServiceBuilder`](substrate.dev/rustdocs/v2.0.0-rc3/sc_service/struct.ServiceBuilder.html). The
`ServiceBuilder` is responsible for assembling all of the necessary pieces that a node will need,
and creating a [`Substrate Service`](substrate.dev/rustdocs/v2.0.0-rc3/sc_service/struct.Service.html) which
will manage the communication between them.

We begin by invoking the
[`native_executor_instance!` macro](substrate.dev/rustdocs/v2.0.0-rc3/sc_executor/macro.native_executor_instance.html).
...
[`sc-consensus-manual-seal` crate](substrate.dev/rustdocs/v2.0.0-rc3/sc_consensus_manual_seal/index.html).
...
[`Proposer`](substrate.dev/rustdocs/v2.0.0-rc3/sc_basic_authorship/struct.Proposer.html) which will be
...
[`spawn_essential_task` method](substrate.dev/rustdocs/v2.0.0-rc3/sc_service/struct.Service.html#method.spawn_essential_task).
