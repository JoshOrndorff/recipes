...
In addition to the
[`WeightData` Trait](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/weights/trait.WeighData.html), shown
above, types that are used to calculate transaction weights must also implement
[`ClassifyDispatch`](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/weights/trait.ClassifyDispatch.html),
and [`PaysFee`](https://substrate.dev/rustdocs/v2.0.0-rc3/frame_support/weights/trait.PaysFee.html).
