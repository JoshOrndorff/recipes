...
-   `: map hasher(blake2_128_concat)` - beginning of the type declaration. This is a map and it will
    use the
    [`blake2_128_concat`](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/trait.Hashable.html#tymethod.blake2_128_concat)
...
[`StorageMap` trait](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/storage/trait.StorageMap.html). You do
