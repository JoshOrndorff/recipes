...
-   Substrate's
    [`BlockImport` trait](https://substrate.dev/rustdocs/v2.0.0-rc3/sp_consensus/block_import/trait.BlockImport.html)
-   Substrate's [import pipeline](https://substrate.dev/rustdocs/v2.0.0-rc3/sp_consensus/import_queue/index.html)
-   Structure of a typical [Substrate Service](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_service/index.html)
-   Configuration of
    [`InherentDataProvider`](https://substrate.dev/rustdocs/v2.0.0-rc3/sp_authorship/struct.InherentDataProvider.html)s
...
[pre-runtime digests](https://substrate.dev/rustdocs/v2.0.0-rc3/sp_runtime/generic/enum.DigestItem.html#variant.PreRuntime).
...
The [Substrate Service](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_service/trait.AbstractService.html) is the main
...
[ServiceBuilder](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_service/struct.ServiceBuilder.html) following
...
[`with_import_queue`](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_service/struct.ServiceBuilder.html#method.with_import_queue).
Here we construct an instance of the
[`PowBlockImport` struct](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_consensus_pow/struct.PowBlockImport.html),
...
[rustdocs tell us](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_consensus_pow/struct.PowBlockImport.html#method.new)
...
[`ProvideInherentData` trait](https://substrate.dev/rustdocs/v2.0.0-rc3/sp_inherents/trait.ProvideInherentData.html)
...
[`TimestampInherentData`](https://substrate.dev/rustdocs/v2.0.0-rc3/sp_timestamp/trait.TimestampInherentData.html)
expected by the [timestamp pallet](https://substrate.dev/rustdocs/v2.0.0-rc3/pallet_timestamp/index.html). In order
...
[`start_mine` function](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_consensus_pow/fn.start_mine.html) requires, and
...
[`FinalityProofRequestBuilder`](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_network/config/trait.FinalityProofRequestBuilder.html).
...
[`DummyFinalityProofRequestBuilder`](https://substrate.dev/rustdocs/v2.0.0-rc3/sc_network/config/struct.DummyFinalityProofRequestBuilder.html)
