...
of [`Currency`](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.Currency.html). For example, it
...
[transfer](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.Currency.html#tymethod.transfer),
[minting](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.Currency.html#tymethod.deposit_into_existing),
and much more.
...
Substrate's [Staking pallet](https://substrate.dev/rustdocs/v2.0.0-rc2/pallet_staking/index.html) similarly uses
[`LockableCurrency`](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.LockableCurrency.html)
...
[`LockIdentifier`](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/type.LockIdentifier.html).
...
[`Imbalance`](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.Imbalance.html) type to express
...
[`OnUnbalanced`](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.OnUnbalanced.html) handler is
