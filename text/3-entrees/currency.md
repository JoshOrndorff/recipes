...
[`Currency`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.Currency.html) trait from
`frame_support`.
...
of [`Currency`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.Currency.html). For example, it
...
[transfer](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.Currency.html#tymethod.transfer),
[minting](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.Currency.html#tymethod.deposit_into_existing),
and much more.

## Reservable Currency

Substrate's [Treasury pallet](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_treasury/index.html) uses the
`Currency` type for bonding spending proposals. To reserve and unreserve funds for bonding,
`treasury` uses the
[`ReservableCurrency`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.ReservableCurrency.html)
...
Substrate's [Staking pallet](https://substrate.dev/rustdocs/v2.0.0-rc5/pallet_staking/index.html) similarly uses
[`LockableCurrency`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.LockableCurrency.html)
...
[`LockIdentifier`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/type.LockIdentifier.html).
...
[`Imbalance`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.Imbalance.html) type to express
...
[`OnUnbalanced`](https://substrate.dev/rustdocs/v2.0.0-rc5/frame_support/traits/trait.OnUnbalanced.html) handler is
