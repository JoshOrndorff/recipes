...
[`PowAlgorithm` trait](substrate.dev/rustdocs/v2.0.0-rc3/sc_consensus_pow/trait.PowAlgorithm.html). Before we
...
[`Client`](substrate.dev/rustdocs/v2.0.0-rc3/sc_service/client/struct.Client.html) so it can call the
...
the [`DifficultyAPI`](substrate.dev/rustdocs/v2.0.0-rc3/sp_consensus_pow/trait.DifficultyApi.html) necessary
