...
set with
[`set_block_number`](substrate.dev/rustdocs/v2.0.0-rc3/frame_system/struct.Module.html#method.set_block_number)
...
[`execute_with`](substrate.dev/rustdocs/v2.0.0-rc3/sp_state_machine/struct.TestExternalities.html#method.execute_with)
...
[`TestExternalities`](substrate.dev/rustdocs/v2.0.0-rc3/sp_state_machine/struct.TestExternalities.html).
[Externalities](substrate.dev/rustdocs/v2.0.0-rc3/sp_externalities/index.html) are an abstraction that allows
...
[`impl_outer_origin`](substrate.dev/rustdocs/v2.0.0-rc3/frame_support/macro.impl_outer_origin.html) macro
from `support`
...
[trait bound](substrate.dev/rustdocs/v2.0.0-rc3/frame_system/trait.Trait.html#associatedtype.AccountId),
