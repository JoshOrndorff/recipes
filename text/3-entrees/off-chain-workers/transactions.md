...
implement the
[`CreateSignedTransaction` trait](substrate.dev/rustdocs/v2.0.0-rc3/frame_system/offchain/trait.CreateSignedTransaction.html).
...
the outer node's [service](substrate.dev/rustdocs/v2.0.0-rc3/sc_service/index.html).
