...
[`Randomness` trait](https://substrate.dev/rustdocs/v2.0.0-rc2/frame_support/traits/trait.Randomness.html), and
...
We've provided the `Output` type as [`H256`](https://substrate.dev/rustdocs/v2.0.0-rc2/sp_core/struct.H256.html).

## Collective Coin Flipping

Substrate's
[Randomness Collective Flip pallet](https://substrate.dev/rustdocs/v2.0.0-rc2/pallet_randomness_collective_flip/index.html)
...
Substrate's [Babe pallet](https://substrate.dev/rustdocs/v2.0.0-rc2/pallet_babe/index.html) which is primarily
