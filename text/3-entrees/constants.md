...
[`Get`](substrate.dev/rustdocs/v2.0.0-rc3/frame_support/traits/trait.Get.html) trait from `frame_support`
...
using the
[`parameter_types!` macro](substrate.dev/rustdocs/v2.0.0-rc3/frame_support/macro.parameter_types.html). This
