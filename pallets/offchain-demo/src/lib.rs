...
impl<T: Trait> Module<T> {
	...
	fn fetch_if_needed() -> Result<(), Error<T>> {
		...
		//
		// Ref: substrate.dev/rustdocs/v2.0.0-rc3/sp_runtime/offchain/storage/struct.StorageValueRef.html
	...
	fn fetch_from_remote() -> Result<Vec<u8>, Error<T>> {
		...
		//   ref: substrate.dev/rustdocs/v2.0.0-rc3/sp_runtime/offchain/http/struct.PendingRequest.html#method.try_wait
