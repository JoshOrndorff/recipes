...
- [Best Practices](./design/README.md)
 ...
 - [Condition Oriented Programming](./design/cop.md)
    - [Fixed Point Arithmetic](./design/safemath.md)
    - [Verifying Signed Messages](#verify)
    - [Check for Collisions](#collide)
    - [Check for Overflow/Underflow](#underflow)
    - [Manage State with Enums](#enums)
