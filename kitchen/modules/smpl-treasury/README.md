...
* [Instantiate a Pot](#pot)
* [Spend Requests](#proxytransfers) (needs to be updated)
* [Schedule Spending](#schedule)    (needs to be updated)

## Instantiate a Pot <a name = "pot"></a>
...
## Spend Requests <a name = "proxytransfers"></a>
...
## Scheduling Spending <a name = "schedule"></a>
